...
class UsuariosNoAptos(models.Model):
    ...
    # Campos adicionales como CharField
    codigo_eps = models.CharField(max_length=200, blank=True, null=True)
    tipo_documento_cotizante = models.CharField(max_length=200, blank=True, null=True)
    tipo_documento_afiliado = models.CharField(max_length=200, blank=True, null=True)
    numero_documento_afiliado = models.CharField(max_length=200, blank=True, null=True)
    primer_apellido_afiliado = models.CharField(max_length=200, blank=True, null=True)
    segundo_apellido_afiliado = models.CharField(max_length=200, blank=True, null=True)
    primer_nombre_afiliado = models.CharField(max_length=200, blank=True, null=True)
    segundo_nombre_afiliado = models.CharField(max_length=200, blank=True, null=True)
