"""
Django settings for auditoria_cuentas project.
...
SECRET_KEY = 'django-insecure--rns78#fhq*77=7e2q0m@j!pq9ld#-(v)7t07^dl_-s*=b=pjh'
...
WSGI_APPLICATION = 'auditoria_cuentas.wsgi.application'
